  ...
  return (
      ...
      {windowWidth <= 600 ? (
        <div className={styles.nav}>
          {" "}
          <Image src={Hamburger} width={45} height={45} />
        </div>
      ) : (
        <Navbar />
      )}
              ...
              <div className={styles.left_section}>
                ...
                <div>
                  ...
                  <p>
                    ...
                    strive to ensure that their websites are listed on some of
                    the popular sites in the industry of travel.
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className={styles.right_section}>
              <div className={styles.left_section}>
                ...
                <div>
                  ...
                  <p>
                    We stress upon the mobile optimizations since the mobile
                    phone use by search is highly prevalent. They are more able
                    to score the best SEO rankings and can easily be viewed on
                    mobile devices.
                  </p>
                </div>
              </div>
